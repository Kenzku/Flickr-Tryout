 ...
 * Time: 13:23
 */
/*global define, test, asyncTest, start, ok, equal, expect, HTMLCanvasElement, deepEqual*/
define(['../../javascripts/photo.js'],
    function (Photo) {
        "use strict";
        return {
            RunTests : function () {
                ...
                test('create canvas - 1', function () {
                    ...
                    aCanvas = aPhoto.createCanvas(callback);
